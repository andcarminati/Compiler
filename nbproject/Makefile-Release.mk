...
${OBJECTDIR}/src/code_generator.o: src/code_generator.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/code_generator.o src/code_generator.c

${OBJECTDIR}/src/error_report.o: src/error_report.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/error_report.o src/error_report.c

${OBJECTDIR}/src/lex.yy.o: src/lex.yy.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lex.yy.o src/lex.yy.c
...
${OBJECTDIR}/src/semantic.o: src/semantic.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/semantic.o src/semantic.c

${OBJECTDIR}/src/sint.o: src/sint.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sint.o src/sint.c

${OBJECTDIR}/src/symbol_table.o: src/symbol_table.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/symbol_table.o src/symbol_table.c

${OBJECTDIR}/src/x86/assembler.o: src/x86/assembler.c 
	${MKDIR} -p ${OBJECTDIR}/src/x86
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/x86/assembler.o src/x86/assembler.c

${OBJECTDIR}/src/x86/x86code_generator.o: src/x86/x86code_generator.c 
	${MKDIR} -p ${OBJECTDIR}/src/x86
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/x86/x86code_generator.o src/x86/x86code_generator.c
